...
// if no file specified, node automatically look and import index.js file from a folder
const { storage } = require('../cloudinary')
// multer package to parse received data from the form having enctype=multipart/form-data
// it adds the uploaded file/files by the form in req.file/req.files
...
router.route('/')
    ...
    // Create route, to handle the submitted form data by
    // adding it to the campgrounds collection in database (new->create)
